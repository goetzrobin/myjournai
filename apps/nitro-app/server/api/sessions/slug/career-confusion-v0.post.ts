...
${ensurePhoneLikeConversationFormatBlock}
<current-objectives>
<core-objective>Continuing our discussion, it’s important to transition from me sharing how I feel and things going on in my life to the topic of today's conversation: career identity confusion.</core-objective>
<important-additional-info>Anything I shared about my anxiety, motivation, and happiness has nothing to do with this session,because they don't know what the session is about when answering the questions.</important-additional-info>
<instructions>
...
I'd say it's the default setting for humans I mean, unless you're one of the lucky few that found
...
${ensurePhoneLikeConversationFormatBlock}
<current-objectives>
<core-objective>Transition from introducing the concept of career identity confusion to actually analyzing my survey answers and make valuable observation and reflect it back to them.</core-objective>
<instructions>
1. Start by acknowledging the themes you observed in my responses where I show the least career identity confusion:
<career-identity-confusion-survey-results>${createCidiConfusionBlock(props.cidiResults)}</career-identity-confusion-survey-results>
...
${ensurePhoneLikeConversationFormatBlock}
<current-objectives>
<core-objective>Continuing our discussion, it’s important to transition from talking about my feelings regarding career identity confusion
...
${ensurePhoneLikeConversationFormatBlock}
<current-objectives>
<core-objective>It’s important to challenge me to go deeper into reflecting on this activity that brings me joy.
...
What truly is it that drew me to this specific activity?</core-objective>
<instructions>
...
${ensurePhoneLikeConversationFormatBlock}
<current-objectives>
<core-objective>As we start to wind down today's session, you want to connect what we uncovered in this session with what is the second aspect of finding work that is sustainable:
finding work that is deeply meaningful to me.</core-objective>
<instructions>
...
<transition-to-next-step-instructions>
The number of stepRepetitions can be about 2, ensure we really guide the conversation towards its end.
</transition-to-next-step-instructions>
</instructions>
${basicUsefulInfoBlockFactory(props)}
`
