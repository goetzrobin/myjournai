  ...
  component: () => {
    ...
    return <OnboardingWrapper link={{ to: lastStep, label: 'Continue where you left off' }}>
      <div className="-mt-20 place-self-center">
        ...
        <p className="mt-4 text-muted-foreground text-center">Seems like we didn't have enough time to get through everything last time! But worry not, you can pick up right where you left off!</p>
      </div>
    </OnboardingWrapper>
  }
})
