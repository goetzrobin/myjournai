import { queryUserBy } from './user.queryhandler';
//TODO: need to figure out a better way to do this and avoid circular dep
import { queryOnboardingLetterBy } from './profile/user-profile.queryhandler';

export const getUserInfoBlock = async (userId: string) => {
...
export const getBasicUserInfoBlock = async (userId: string) => {
